...
export default function Testimonials() {
  return (
    <section id="Testimonials" className="py-20 md:py-24 bg-black rounded-md">
        <h2 className="text-white text-5xl md:text-7xl font-medium text-center tracking-tighter">Framer Motion Integration</h2>
        <p className="text-white/70 max-w-lg mx-auto text-lg md:text-xl tracking-tight text-center mt-5 px-5">
          Animated design is a great way to enhance the user experience. Framer Motion is an essential component to my tech stack.
        </p>
          ...
          className="flex gap-5 flex-none">
            {[...testimonials, ...testimonials].map(testimonial => (
              <div key={testimonial.name} className="border border-white/15 p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(0,0,100,.5),black)] max-w-xs md:max-w-md flex-none">
                <div className="text-white text-lg tracking-tight md:text-2xl">{testimonial.text}</div>
